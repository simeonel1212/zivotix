...
export default function OrdersPage() {
  return (
    <main className="flex-1 mx-auto w-full max-w-xl px-6 py-16">
      <h1 className="text-4xl font-bold tracking-tight text-neutral-900">My Orders</h1>
      <p className="mt-2 text-neutral-500">Your tickets are delivered by email the moment payment clears.</p>

      <div className="zv-card p-6 sm:p-8 mt-8 space-y-5 text-sm text-neutral-700 leading-relaxed">
        <div>
          <p className="font-semibold text-neutral-900">Where are my tickets?</p>
          <p className="mt-1 text-neutral-500">
            Search your inbox for <span className="font-medium text-neutral-800">&quot;Your tickets&quot;</span> or
            the event name. The email includes each ticket&apos;s QR code and a link to view it online. Check your
            spam folder too.
          </p>
        </div>
        <div>
          <p className="font-semibold text-neutral-900">Can&apos;t find the email?</p>
          <p className="mt-1 text-neutral-500">
