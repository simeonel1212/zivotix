  ...
  return (
    <div className="space-y-10 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-sm text-neutral-400 mt-1">A quick look at how things are going.</p>
      </div>
      ...
      <div>
        <h2 className="font-semibold text-neutral-50 mb-3">Recent orders</h2>
        {(orders ?? []).length === 0 ? (
                  ...
                  {(orders ?? [])
                    ...
                    .map((o) => (
                      <tr key={o.id} className="border-t border-white/10">
                        <td className="px-5 py-3 font-medium text-neutral-100 whitespace-nowrap">{o.buyer_name}</td>
