...
export default async function OrganizerCommunityPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-10">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-neutral-50">Community</h1>
      ...
      <div>
        <h2 className="font-semibold text-neutral-50 mb-3">Your updates</h2>
        {!posts || posts.length === 0 ? (
          <div className="zv-card p-10 text-center">
            <p className="text-sm text-neutral-500">No updates posted yet.</p>
          </div>
        ) : (
              ...
              return (
                <div key={post.id} className="zv-card p-5">
                  <div className="flex items-start justify-between gap-4">
                    <p className="text-sm text-neutral-100 whitespace-pre-wrap flex-1">{post.body}</p>
